...
## Files
- `sphere10.krn`: intrinsic material parameters
- `sphere10.p2`: mesh scale, field sweep, and minimizer settings
- `run_sphere10.sh`: generates the mesh and runs the simulation
