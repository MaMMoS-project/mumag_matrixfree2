...
def tracked_jit(fun=None, **kwargs):
    ...
    Args:
        fun (Callable, optional): function to JIT.
        **kwargs: JIT arguments.

    Returns:
        Callable: JIT-compiled function with tracking.
    """
    if fun is None:
...
def test_compilation():
    ...
    def wrap_with_print(name, original_make):
        ...
        Args:
            name (str): Label for the log entry.
            original_make (Callable): The original factory function.
