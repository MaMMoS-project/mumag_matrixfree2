...
def approx_max_volume_from_edge(h: float) -> float:
    ...
    # We use 0.2 * (h**3) rather than the exact volume of a regular tetrahedron
    # because the mean volume generated by TetGen is typically smaller than the max.
    # A max constraint of 0.2 shifts the mean edge length to accurately reflect target h.
    return 0.2 * (h**3)
