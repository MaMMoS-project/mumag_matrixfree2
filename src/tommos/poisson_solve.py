"""Assembled sparse Poisson operator and PCG solver.

Supports multiple preconditioners (Jacobi, Chebyshev, AMG) and warm starts.
...
def make_poisson_ops(  # noqa: D417
    ...
    *,
    ...
    """Create JIT-compiled operators backed by assembled sparse matrices.
    ...
    Args:
        ...
        reg (float, optional): Tikhonov regularization for the diagonal.
            Defaults to 1e-12.
        assembly (Assembly, optional): Nodal assembly method. Defaults to 'segment_sum'.
        boundary_mask (Array | None, optional): Dirichlet boundary mask
            (0.0 at boundary). Defaults to None.
        A_sparse (Any | None): Assembled sparse stiffness operator.
...
def make_pcg_solve(
    ...
    *,
    ...
    def apply_Minv(sparse_ops: dict, r: Array, hierarchy: list | None = None) -> Array:
        ...
        Mdiag_dyn = sparse_ops.get("Mdiag", sparse_ops.get("A_diag", Mdiag))
...
def make_solve_U(  # noqa: D417
    ...
    *,
...
) -> tuple[Callable[..., Array | tuple[Array, int, float]], Any | None]:
    """Create a high-level Poisson solver for assembled sparse operators.
    ...
    Args:
        ...
        cg_maxiter (int, optional): Maximum PCG iterations. Defaults to 2000.
        ...
        enforce_zero_mean (bool | None, optional): Whether to enforce a zero-mean
            potential. Defaults to automatic selection based on the boundary mask.
        boundary_mask (Array | None, optional): Dirichlet boundary mask.
            Defaults to None.
        assembly (Assembly, optional): Nodal assembly method. Defaults to 'scatter'.
        A_sparse (Any | None): Assembled sparse stiffness operator.
        A_diag (Array | None): Precomputed diagonal of Poisson stiffness matrix A.
        A_scipy (Any | None, optional): SciPy representation of the stiffness matrix.
            Defaults to None.
        cpu_spmv_backend (str, optional): Backend used for CPU sparse matrix-vector
            products.
        poisson_solver (str, optional): Linear solver backend. Defaults to 'jax'.
        mesh (jax.sharding.Mesh | None, optional): Device mesh. Defaults to None.

    Returns:
        tuple[Callable, Any | None]: Solver callable and optional AMG hierarchy.
    """
