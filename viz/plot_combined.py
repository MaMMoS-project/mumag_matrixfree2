...
pcohen_csv = (
    "/ceph/home/schrefl/jax_dev/test_matrixfree2/Nd0.5Fe0.5/results_pcohen_assembled_tau1_181774/hysteresis.csv"
)
...
plt.plot(
    df_pcohen_hs[:, 1], df_pcohen_hs[:, 2], "o-", label="CG (Hestenes-Stiefel) [Correct]", color="blue", markersize=5
)
...
plt.plot(
    df_pcohen[:, 1], df_pcohen[:, 2], "^:", label="CG (Polak-Ribière) [Vaults Barrier]", color="orange", markersize=6
)
