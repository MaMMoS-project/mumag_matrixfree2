...
def test_compare():
    ...
    lib.solve_Py_g.argtypes = [
        ...
        ctypes.POINTER(ctypes.c_double),
        ctypes.POINTER(ctypes.c_double),
        ctypes.POINTER(ctypes.c_double),  # m, g_ext, g_tan_ext, inv_M_prec
        ctypes.c_void_p,
        ctypes.c_int,
        ctypes.c_double,
        ctypes.c_double,
        ctypes.c_double,
        ctypes.c_double,  # K_eff, max_iter, tol, reg, stagnation_nu, inv_Vmag
        ctypes.POINTER(ctypes.c_double),
        ctypes.POINTER(ctypes.c_int),  # y, out_iters
    ]
