...
\begin{table}[h]
    ...
    \begin{tabular}{lrrrr}
        ...
        \midrule
        Morton (GPU-optimized) & \textbf{14.93} & 57.0 & \textbf{0.262} & - \\
        RCM (CPU-optimized)    & 15.52 & \textbf{55.0} & 0.282 & \textbf{2.69$\times$} \\
        \bottomrule
    \end{tabular}
    \caption{CPU benchmark comparison of mesh reordering strategies on a 4-core CPU node (\texttt{Gd}) for the Hestenes-Stiefel CSR solver.}
