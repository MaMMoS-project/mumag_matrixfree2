...
\begin{table}[h]
    ...
    \begin{tabular}{lrrrr}
        \toprule
        \textbf{Reordering Target} & \textbf{Avg. Step Time (s)} & \textbf{Avg. PCG Iters/Step} & \textbf{Time/PCG Iter (s)} & \textbf{Footprint Reduction} \\
        \midrule
        Morton (Standard CPU SpMV) & 14.93 & 57.0 & \textbf{0.262} & - \\
        Morton + MKL Inspector-Executor & \textbf{14.92} & \textbf{54.0} & 0.276 & - \\
        RCM (CPU-optimized)    & 15.52 & 55.0 & 0.282 & \textbf{2.69$\times$} \\
        \bottomrule
    \end{tabular}
    \caption{CPU benchmark comparison of mesh reordering strategies and MKL optimization on a 4-core CPU node (\texttt{Gd}) for the Hestenes-Stiefel CSR solver.}
