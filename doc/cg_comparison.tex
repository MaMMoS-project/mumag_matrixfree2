...
\begin{table}[h]
    ...
    \begin{tabular}{lrrrrr}
        ...
        \midrule
        \texttt{b4vex} (C++ Reference) & 2043.2 & \textbf{10,475} & 23,086 & 102,025 & 194,927 \\
        \texttt{pcohen\_hs} (JAX assembled CSR) & \textbf{649.1} & 13,046 & 15,520 & \textbf{97,104} & \textbf{171,288} \\
...
\begin{itemize}
    \item \textbf{\texttt{pcohen\_hs} Speedup:} The JAX Hestenes-Stiefel variant of Cohen's Conjugate Gradient method completes the hysteresis loop in \textbf{649.1 seconds}, compared to \textbf{2043.2 seconds} for the C++ reference. This represents a \textbf{$3.15\times$ wall-clock speedup}. While JAX requires slightly more outer iterations (13,046 vs 10,475), the computational cost per step is dramatically lower.
