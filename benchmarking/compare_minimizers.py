...
def main():
    ...
    geom = TetGeom(
        conn=jnp.asarray(conn32), volume=jnp.asarray(volume), mat_id=jnp.asarray(mat_id), JinvT=jnp.asarray(JinvT)
    )
        ...
        try:
            if method == "bb":
                ...
                bb_params = {
                    ...
                    if k in ["max_iter", "tau_f", "eps_a", "tau0", "ls_eta1", "ls_eta2", "ls_C", "ls_c"]
                }
